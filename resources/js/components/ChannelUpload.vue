<template>
  <div class="col-md-8">
      <input type="file" multiple ref="videos" id="video-files" hidden @change="uploadVideo()">
      <div class="card p-3 d-flex justify-content-center align-items-center" v-if="!selected">
        <svg onclick="document.getElementById('video-files').click()" width="70px" height="70px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
    ...
    <polygon style="fill:#FFFFFF;" points="231.88,193.936 297.896,232.048 231.88,270.16 "/>
    <polygon style="fill:#2D2D2D;" points="285.152,371.816 256.08,330.52 227.008,371.816 247.032,371.816 247.032,371.816 
      247.032,416.4 266.088,416.4 266.088,371.816 "/>
        </svg>
